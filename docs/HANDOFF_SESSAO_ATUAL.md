...
> Projeto: **SO Multi Agente** (app desktop Tauri 2 + React/TS, `D:\Projetos\alethe-agents`).
...
- **HMR de store Zustand NÃO é automático** pro corpo das actions — editar um
  ...
  **Se algo continuar "com bug antigo" mesmo depois de um fix, a explicação mais
  ...
  código novo está rodando depois de um reload da janela do SO Multi Agente (F5/Ctrl+R) ou
