...
async function boot() {
  if (!token) { app.innerHTML = '<div class="fatal"><div class="fatal-card"><span class="brand-mark">›_</span><strong>Se requiere el enlace de emparejamiento</strong><p>Escanea el código QR que muestra SO Multi Agente para conectar este dispositivo.</p></div></div>'; return }
  app.innerHTML = '<div class="loading"><div class="loading-card"><span class="brand-mark">›_</span><strong>Conectando con SO Multi Agente</strong><p>Preparando su espacio de trabajo remoto…</p></div></div>'
