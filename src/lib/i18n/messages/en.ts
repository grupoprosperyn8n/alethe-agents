...
export const en = {
  /* ---- loading ---- */
  'clone.cloningBody': 'Starting the clone of {url} and generating the AI context briefing...',
  'clone.cloningTitle': 'Cloning repository',
  'clone.errorTitle': 'Clone error',
  'clone.successBody': 'Clone completed successfully. AI context injected into AGENTS.md and CLAUDE.md.',
  'clone.successTitle': 'Repository cloned',
  'common.closeNotification': 'Close notification',
  'crud.editProjectConfirmRemoveAgentEnv': 'Remove agent environment "{agentId}"?',
  'crud.editProjectRemoveAgentEnvFailed': 'Could not remove: {error}',
  'diff.binaryFile': 'Binary file',
  'discord.managingTerminals': 'Managing terminals',
  'discord.orchestratingAgents': 'Orchestrating AI agents',
  'discord.testingOrchestration': 'Testing agent orchestration',
  'discord.viewingDashboard': 'Viewing the dashboard',
  'discord.workingWithAlethe': 'Working with SO Multi Agente',
  'fileExplorer.loadFailed': 'Could not read this folder.',
  'fileExplorer.loading': 'Loading...',
  'fileExplorer.noActiveFolder': 'This terminal has no active folder.',
  'fileExplorer.refreshFiles': 'Refresh files',
  'image.asciiRenderingAlt': 'ASCII rendering',
  'image.defaultPhotoTitle': 'Default photo',
  'image.iconPreviewAlt': 'Icon preview',
  'image.previewTitle': 'Photo/icon preview',
  ...
  'onboarding.gitSubtitle':
    'Show repository changes, stage files, and create commits without leaving SO Multi Agente.',
  ...
  /* ---- welcome ---- */
  'prefs.appIconThemeAria': 'App icon theme',
  'prefs.appIconThemeDesc': 'Choose the desktop icon independently from the interface theme.',
  'prefs.appIconThemeTitle': 'App icon theme',
  'prefs.installPluginButton': 'Install new plugin (JSON)',
  'prefs.multiagentTraceTask': 'Task: {taskId}',
  'prefs.pluginAutocommitError': 'Could not change autocommit: {error}',
  'prefs.pluginConfirmUninstall': 'Uninstall plugin "{id}"?',
  'prefs.pluginEmpty': 'No plugins installed right now.',
  'prefs.pluginInstallError': 'Could not install plugin: {error}',
  'prefs.pluginInstallSuccess': 'Plugin installed successfully.',
  'prefs.pluginInvalidManifest': 'Invalid manifest. Fill in name, version, and kind.',
  'prefs.pluginLoading': 'Loading plugins...',
  'prefs.pluginManagerDesc': 'View and install orchestrator plugins and custom tools.',
  'prefs.pluginManagerTitle': 'Plugin manager',
  'prefs.pluginPasteManifest': 'Paste the plugin manifest JSON:',
  'prefs.pluginUninstallError': 'Could not uninstall plugin: {error}',
  'prefs.pluginUninstallSuccess': 'Plugin uninstalled.',
  'sandbox.messageSourceAgent': 'Message source agent',
  'sandbox.messageTargetAgent': 'Message target agent',
  'todo.defaultOpenReadme': 'Open project README',
  'todo.defaultPlanNextStep': 'Plan next implementation step',
  'todo.defaultReviewWorkspace': 'Review active workspace',
  'ui.markdown.noFile': 'no file',
  'ui.sidebar.addTerminalFirst': 'Add a terminal to the project first to get the repository root.',
  'update.noPendingUpdate': 'There is no pending update to install.',
  ...
  'profiles.backupFileType': 'SO Multi Agente account backup',
  ...
  'remote.description': 'Scan this QR code from a phone on the same network to open SO Multi Agente Remote.',
  ...
  'remote.settingsStatusDesc': 'Control whether SO Multi Agente accepts remote connections on the local network.',
  ...
  'prefs.categoryAccountDesc': 'Manage your local profile, language, and SO Multi Agente accounts.',
  ...
  'prefs.categoryIntegrationsDesc': 'Connect external services and control what SO Multi Agente shares.',
  'prefs.categoryUpdates': 'Updates',
  'prefs.categoryUpdatesDesc': 'Check your installed version and look for SO Multi Agente updates.',
  ...
  'prefs.uiThemeDesc': 'Choose the palette used throughout the SO Multi Agente interface.',
  ...
  'prefs.windowOpacityDesc': 'Let the desktop show through the entire SO Multi Agente window.',
  ...
  'prefs.featuresDesc': 'Choose which optional modules are visible in SO Multi Agente.',
  ...
  'prefs.resourcePolicyManualHint':
    'SO Multi Agente still measures and warns, but does not park runtimes or pause new spawns automatically.',
  ...
  'prefs.multiagentSelectProjectAria': 'Select a project',
  ...
  'prefs.cliStale':
    'The installed command points to an older copy of SO Multi Agente. Reinstall it to update the path.',
  'prefs.cliNotOnPath':
  ...
  'prefs.spotifyClientId': 'Client ID',
  'prefs.spotifyClientSecret': 'Client Secret',
  ...
  'prefs.discordPresenceHint': 'Shows that you are using SO Multi Agente without exposing project names.',
  ...
  'prefs.checkUpdatesDesc': 'Check whether a newer version of SO Multi Agente is available to download.',
  'prefs.installedVersion': 'Installed version',
  'prefs.checkNow': 'Check for updates',
  'prefs.checkingUpdates': 'Checking…',
  'prefs.upToDate': 'SO Multi Agente is up to date.',
  ...
  'todo.resetDefault': 'Reset to SO Multi Agente default Todo',
  'todo.resetDefaultConfirm': 'Replace your current Todo list with the SO Multi Agente default list?',
  ...
  'whatsNew.subtitle': 'SO Multi Agente keeps getting sharper.',
  ...
  'whatsNew.v130.note8': 'Experimental window opacity control, to see the desktop through SO Multi Agente.',
  ...
  'browser.embedHint': 'Opens inside SO Multi Agente. Some sites may block embedded viewing.',
  ...
  'appClose.title': 'Close SO Multi Agente?',
  'appClose.message':
    'Open agents and terminals will be stopped. Saved conversations can be resumed the next time you open SO Multi Agente.',
  'appClose.confirm': 'Close SO Multi Agente',
  'appClose.cancel': 'Cancel',
  'appClose.failedTitle': 'SO Multi Agente could not close',
  ...
  'ws.confirmOverwriteForeignAgent':
    'An agent "{name}" that was NOT created by SO Multi Agente already exists in this project. Overwrite?',
  'ws.confirmRemoveAgent': 'Remove the agent "{name}" from the project?',
  'ws.confirmRemoveForeignAgent': 'The agent "{name}" was NOT created by SO Multi Agente. Remove it anyway?',
  ...
  /* ---- crash watch ---- */
  'crash.uncleanTitle': 'SO Multi Agente closed unexpectedly',
  ...
  'update.checkFailedBody':
    'SO Multi Agente could not reach the update service. Check your connection and try again.',
  ...
  'prefs.aboutVersionDesc': 'The SO Multi Agente build currently installed.',
  'prefs.aboutUpdatesTitle': 'Updates',
  'prefs.aboutUpdatesDesc': 'Check for and install new versions of SO Multi Agente.',
  ...
  'update.checkSuccessTitle': 'SO Multi Agente is up to date',
  ...
  'resource.warning.body': 'SO Multi Agente is using about {total} MB. Hidden idle runtimes may be parked.',
  'resource.critical.title': 'Memory budget reached',
  'resource.critical.body':
    'SO Multi Agente is using about {total} MB. New runtimes are paused until memory recovers.',
  ...
  'sandbox.subtitle': 'A real planner-to-worker POC: Claude Code plans, Codex implements, and SO Multi Agente relays the handoff.',
  ...
  'multiAgent.agentWorktreeLabel': 'Agent: {agentId} ({mode})',
  'multiAgent.modeCopy': 'Copy',
